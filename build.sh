...
docker build -f docker/Dockerfile -t 192.168.10.124:8889/public/eureka:latest .
docker push 192.168.10.124:8889/public/eureka:latest
docker rmi 192.168.10.124:8889/public/eureka:latest
